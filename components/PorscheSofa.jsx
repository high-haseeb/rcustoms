...
export function PorscheSofa({ carColor, colors, ...props }) {
  ...
  const tempBodyColor = new THREE.MeshStandardMaterial({
    color: carColor,
    roughness: 0.1,
    metallness: 1,
  });
    ...
    <group {...props} dispose={null}>
      <group position={[13.039, 0.937, 3.016]} rotation={[0, -0.422, 0]}>
        <mesh
          ...
          position={[0, -0.58, 1.426]}
        />
        <mesh
          geometry={nodes.Seat_Leather_EXT004.geometry}
          material={newLeatherMaterial1}
          position={[0, -0.58, 1.426]}
        />
        <mesh
          geometry={nodes.Seat_Leather_EXT005.geometry}
          material={newLeatherMaterial1}
          position={[0, -0.58, 1.426]}
        />
        <mesh
          geometry={nodes.Seat_Leather_EXT006.geometry}
          material={newLeatherMaterial1}
          position={[0, -0.58, 1.426]}
        />
      </group>
      <group position={[13.039, 0.937, 3.016]} rotation={[0, -0.422, 0]}>
        <group position={[0, -0.58, 1.426]}>
          ...
          <mesh
            ...
            material={materials["911_Automotive_LED_Red"]}
          />
        </group>
        <mesh
          geometry={nodes.Taillight_Glass_3D_11.geometry}
          material={materials["911_Glass_Tail"]}
          position={[0, 0, 1.424]}
        />
        <mesh
          geometry={nodes.Taillight_Blackbody_Wall.geometry}
          material={materials["911_Matte_Black"]}
          position={[0, 0, 1.426]}
        />
        <mesh
        ...
        <mesh
          ...
          material={materials["911_Chrome"]}
          position={[-0.562, -0.01, -0.65]}
        />
        <mesh
        ...
        <mesh
          ...
          material={materials["911_Chrome.001"]}
          position={[-0.831, -0.018, -0.317]}
        />
        <mesh
          geometry={nodes["911_Taillight_Side"].geometry}
          material={materials["911_TL_Emission_A"]}
          position={[-0.781, -0.021, -0.307]}
          rotation={[-1.399, 0.302, 1.095]}
          scale={[0.045, 0.018, 0.018]}
        />
        <mesh
          geometry={nodes["911_Body_101_Taillight"].geometry}
          material={materials.C112_Carpaint}
          position={[0, 0, 1.424]}
        />
        <mesh
          geometry={nodes.bonnet_porsche.geometry}
          material={materials.Carbone}
          position={[-0.001, 0.167, -0.368]}
        />
        <mesh
          geometry={nodes.Bonnet_Blackbody.geometry}
          material={materials.Flat_Black}
          position={[0, 0.295, -0.356]}
          scale={0.1}
        />
        <group position={[0, -0.58, 1.426]}>
        ...
        <mesh
          ...
          material={materials["911_Plastic_Rough"]}
          position={[0, 0, 1.424]}
        />
      </group>
      <mesh
        ...
        material={materials.Glass}
        position={[12.456, 0.358, 4.317]}
        rotation={[-Math.PI, 0.422, 0]}
        scale={-1}
      />
      <group
        position={[12.456, 0.358, 4.317]}
      ...
      <mesh
        ...
        material={materials.Glass}
        position={[13.9, 0.875, 3.046]}
        rotation={[-1.905, 0.976, -0.382]}
        scale={-1}
      />
      <mesh
        geometry={nodes.Taillight_Pattern013.geometry}
        material={materials.Glass}
        position={[13.895, 0.891, 3.026]}
        rotation={[-1.989, 0.854, -0.276]}
        scale={-1}
      />
      <mesh
        geometry={nodes.Taillight_Pattern012.geometry}
        material={materials.Glass}
        position={[13.897, 0.886, 2.975]}
        rotation={[-1.966, 0.803, -0.265]}
        scale={-1}
      />
      <mesh
        geometry={nodes.Taillight_Glass_3D_1008.geometry}
        material={materials["911_Glass_Tail"]}
        position={[12.457, 0.937, 4.315]}
        rotation={[-Math.PI, 0.422, 0]}
        scale={-1}
      />
      <mesh
      ...
      <mesh
        geometry={nodes.path1001.geometry}
        material={materials["Black Glossy"]}
        position={[13.329, 0.92, 2.37]}
        rotation={[-0.896, -0.273, -0.325]}
        scale={-1.407}
      />
      <group
        position={[13.859, 0.907, 2.987]}
        rotation={[-3.11, 0.422, -0.037]}
        scale={[-0.8, -0.934, -0.911]}
      >
        <mesh
      ...
      <group
        position={[12.516, 0.907, 2.384]}
        rotation={[0.031, -0.422, -0.012]}
        scale={[0.8, 0.934, 0.911]}
      >
        <mesh
      ...
      <group
        position={[13.844, 0.926, 2.996]}
        rotation={[-3.048, 0.497, -0.023]}
        scale={[-0.8, -0.8, -0.843]}
      >
        <mesh
          geometry={nodes.Sphere002.geometry}
          material={materials["911_Taillight/Chrome"]}
        />
        <mesh
      ...
      <group
        position={[12.519, 0.926, 2.402]}
        rotation={[0.087, -0.344, 0.051]}
        scale={[0.8, 0.8, 0.843]}
      >
        <mesh
          geometry={nodes.Sphere002.geometry}
      ...
      <mesh
        ...
        material={materials["911_TL_Emission_A"]}
        position={[13.878, 0.916, 3.056]}
        rotation={[1.6, 0.345, 1.538]}
        scale={[-0.045, -0.018, -0.018]}
      />
    </group>
  );
